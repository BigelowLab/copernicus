...
In 2023/2024 Copernicus migrated to a new service model.  Learn more [here](Migrating to the new Global Physical Analysis and Forecasting System). This migration introduced the [Copernicus Marine Toolbox](https://help.marine.copernicus.eu/en/collections/4060068-copernicus-marine-toolbox) which provides a Python API and a command line interface (CLI).  This package leverages the latter.
...
Once you have them you can add them to a file hidden in your home directory. The functions in this package that require the credentials know where to look for them.  We don't actually run this in the README, but you can copy-and-paste to use in R; obviously you will insert your own username and password.
...
The database is very lightand easy to filter for just the records you might need. Note that depth is a character data type; this provides you with flexibility to define depth as 'surface' or '50-75' or something like that.
